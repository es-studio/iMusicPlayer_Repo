...
+ (id)loadingViewInView:(UIView *)aSuperview withTitle:(NSString *)title
{
    ...
    rect.origin.x = 320 / 2 - rect.size.width  / 2;
    rect.origin.y = 480 / 2 - rect.size.height / 2;
...
//    loadingLabel.text = NSLocalizedString(@"Reading ID3 Tags...", nil);
...
//    NSLog(@"%@ will be deallocated", [super class]);
    [super dealloc];
}
